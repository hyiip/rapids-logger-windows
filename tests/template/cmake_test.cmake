...
function(add_cmake_test source_or_dir)
  ...
  add_test(NAME ${test_name}_build COMMAND ${CMAKE_COMMAND} --build ${build_dir} --config Release)
  set_tests_properties(${test_name}_build PROPERTIES DEPENDS ${test_name}_configure)

  if(WIN32)
    add_test(NAME ${test_name}_run COMMAND ${build_dir}/Release/${base_test_name}.exe)
  else()
